  ...
  return (
    <React.Fragment>
      ...
      <main className="p-4 h-screen bg-slate-50">
        ...
        <Link to="/">
          <button className="flex flex-row shadow-3xl pt-2 pb-2 pr-5 m-3 w-auto">
            <span className="mr-5 ml-5">{/* <BsArrowLeft size={26} /> */}</span>
            Back
          </button>
        </Link>
          ...
          <div className="flex flex-col md:flex-col lg:flex-row p-5 pt-8">
            <div className="w-full m-4">
              ...
              <ul className="basic-info">
                ...
                <li>
                  <span className="font-semibold"> Population: </span>11,341,511
                </li>
                <li>
            ...
            <div className="m-0 w-full">
              ...
              <div className="flex flex-row justify-center items-center">
                ...
                <Link to="">
                  <button className="shadow-3xl p-2 m-3 text-sm pr-5 pl-5">
                    France
                  </button>
                </Link>
                <Link to="">
